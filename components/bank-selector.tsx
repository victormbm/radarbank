...
interface BankSelectorProps {
  banks: DashboardBank[];
  onSelectBank: (bank: DashboardBank) => void;
  selectedBank?: DashboardBank | null;
}

export function BankSelector({ banks, onSelectBank, selectedBank }: BankSelectorProps) {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        <Building2 className="h-6 w-6 sm:h-7 sm:w-7 text-purple-400" />
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">Selecione um Banco</h2>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 h-11 text-slate-100 placeholder:text-slate-400 border-slate-300/60 bg-slate-900/35 focus-visible:ring-purple-400"
          />
        </div>
          ...
          <button
            ...
            className={cn(
              ...
              filterType === "all"
                ...
                : "bg-white/90 text-slate-700 hover:bg-white border border-white/70 shadow-sm"
            )}
          >
            Todos
          </button>
          ...
          <Card
            ...
            className={cn(
              ...
              selectedBank?.id === bank.id
                ...
                : "hover:ring-2 hover:ring-purple-300 shadow-md"
            )}
          >
            {(() => {
                  ...
                  <div className="p-3 sm:p-4 lg:p-5 flex flex-col items-center gap-2 sm:gap-3 relative">
                    ...
                    <div className="text-center">
                      <h3 className="font-semibold text-sm text-slate-900 line-clamp-1">
                        {visualBank?.shortName || bank.name}
                      </h3>
                      <p className={cn(
                        "text-xs mt-0.5",
